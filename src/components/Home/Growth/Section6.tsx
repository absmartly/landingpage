...
const Section6: FC<Section6Props> = ({ description, image }) => {
  return (
    <section
      className="relative w-full md:max-h-[75vh] lg:max-h-[65vh] block py-5 md:py-28 bg-blend-soft-light bg-center 
    overflow-hidden px-[15px] md:px-20 text-center bg-primary pattern"
    >
